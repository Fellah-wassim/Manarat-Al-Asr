...
function buildBox(fiaaClass) {
  number = number + 1;
  document.querySelector(".numbering-box-txt").textContent =
    document.querySelector("." + fiaaClass + " .product-name").textContent;
  document.querySelector(".nbr").value = number;
  console.log(document.querySelector(".numbering-box-txt").textContent);
  console.log(document.querySelector(".nbr").value);
}
// function addBox() {
...
//                   <div class="numbering-box"><p class="numbering-box-txt"></p><span class="nbr">1</span></div>
//                 </div>
